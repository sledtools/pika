...
pub struct AgentInstance {
    ...
    pub incus_config: Option<String>,
    pub phase: String,
...
impl AgentInstance {
    pub fn create(
        ...
        Self::create_with_incus_config(conn, owner_npub, agent_id, vm_id, None, phase)
    }

    pub fn create_with_incus_config(
        conn: &mut PgConnection,
        owner_npub: &str,
        agent_id: &str,
        vm_id: Option<&str>,
