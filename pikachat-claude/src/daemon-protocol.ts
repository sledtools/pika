 ...
 *
 * Keep this aligned with crates/pikachat-sidecar/src/protocol.rs.
 */
...
export type PikachatDaemonOutMsg =
  ...
  | {
      type: "group_updated";
      update: {
        kind: "created" | "members_added" | "members_removed" | "profile_updated" | "left";
        nostr_group_id: string;
        member_count?: number | null;
        members?: Array<{ pubkey: string; is_admin: boolean }>;
        profile?: {
          nostr_group_id: string;
          owner_pubkey: string;
          name: string;
...
export type PikachatDaemonInCmd =
  ...
  | { cmd: "add_members"; request_id: string; nostr_group_id: string; peer_pubkeys: string[] }
  | { cmd: "list_members"; request_id: string; nostr_group_id: string }
  | { cmd: "remove_members"; request_id: string; nostr_group_id: string; peer_pubkeys: string[] }
  | { cmd: "leave_group"; request_id: string; nostr_group_id: string }
  | { cmd: "get_group_profile"; request_id: string; nostr_group_id: string }
  | {
  ...
  | { cmd: "get_messages"; request_id: string; nostr_group_id: string; limit?: number }
