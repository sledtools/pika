...
pub struct CallDebugStats {
    ...
    pub concealment_short: u64,
    pub concealment_medium: u64,
    pub concealment_long: u64,
    pub last_rtt_ms: Option<u32>,
    pub reconnect_count: u64,
    pub last_reconnect_duration_ms: Option<u32>,
    pub subscription_ready_latency_ms: Option<u32>,
    pub consecutive_disconnects: u64,
    pub video_tx: u64,
    pub video_rx: u64,
