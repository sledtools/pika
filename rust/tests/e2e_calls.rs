...
// The pure Rust FfiApp↔FfiApp local-MoQ regression boundary is owned by
// pikahut's integration_deterministic selector now. This file keeps only the
// daemon-specific legacy path until that seam is migrated.
