...
fn write_config(data_dir: &str, relay_url: &str, _kp_relay_url: Option<&str>, moq_url: &str) {
...
fn call_over_real_moq_relay() {
    ...
    // Wait for bob's key package to appear on the relay before alice fetches it.
