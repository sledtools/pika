...
case "$installable" in
  .#ci.x86_64-linux.workspaceDeps|.#ci.x86_64-linux.workspaceBuild|.#ci.x86_64-linux.agentContractsWorkspaceDeps|.#ci.x86_64-linux.agentContractsWorkspaceBuild|.#ci.x86_64-linux.notificationsWorkspaceDeps|.#ci.x86_64-linux.notificationsWorkspaceBuild|.#ci.x86_64-linux.fixtureWorkspaceDeps|.#ci.x86_64-linux.fixtureWorkspaceBuild|.#ci.x86_64-linux.rmpWorkspaceDeps|.#ci.x86_64-linux.rmpWorkspaceBuild|.#ci.x86_64-linux.pikachatWorkspaceDeps|.#ci.x86_64-linux.pikachatWorkspaceBuild)
    ;;
  *)
