...
prepare_lane() {
  ...
  "$script_dir/pika-build-run-workspace-deps.sh" --installable .#ci.x86_64-linux.workspaceDeps
  "$script_dir/pika-build-run-workspace-deps.sh" --installable .#ci.x86_64-linux.workspaceBuild
}
