...
- Next seam:
  remove the remaining repo-wide `pika-marmot-runtime` consumers outside `pika_core`, starting with the CLI/sidecar helper surfaces that still depend on the old runtime facade.
