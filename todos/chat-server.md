...
- Next seam:
  remove the next `pika-marmot-runtime` facade slice from `pika_core`, starting with conversation ingress/decrypt interpretation and any remaining backlog helpers that still route through the runtime crate.
