...
- Next seam:
  remove the remaining repo-wide `pika-marmot-runtime` consumers outside `pika_core`, which are now concentrated in the CLI and `pikachat-sidecar`.
