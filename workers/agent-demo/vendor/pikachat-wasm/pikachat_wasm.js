/* @ts-self-types="./pikachat_wasm.d.ts" */
...
export class WasmRuntime {
     ...
     * @returns {string}
     */
    create_outbound_group_message_json(group_id, plaintext) {
        let deferred4_0;
        let deferred4_1;
        try {
            ...
            const ret = wasm.wasmruntime_create_outbound_group_message_json(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
    ...
    /**
     * @param {string | null} [secret_seed_hint]
     * @returns {string}
     */
    init_or_load_identity_json(secret_seed_hint) {
        let deferred3_0;
        let deferred3_1;
        try {
            var ptr0 = isLikeNone(secret_seed_hint) ? 0 : passStringToWasm0(secret_seed_hint, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmruntime_init_or_load_identity_json(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    load_snapshot_json(snapshot_json) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmruntime_load_snapshot_json(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    process_group_message_event_json(group_id, event_json) {
        ...
        try {
            ...
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.wasmruntime_process_group_message_event_json(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
     ...
     * @returns {string}
     */
    process_group_message_json(group_id, event_id, ciphertext_b64) {
        let deferred5_0;
        let deferred5_1;
        try {
            const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            ...
            const ret = wasm.wasmruntime_process_group_message_json(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var ptr4 = ret[0];
            var len4 = ret[1];
            if (ret[3]) {
                ptr4 = 0; len4 = 0;
    ...
    /**
     * @param {string} group_id
     * @param {string} wrapper_event_id_hex
     * @param {string} welcome_event_json
     * @returns {string}
     */
    process_welcome_event_json(group_id, wrapper_event_id_hex, welcome_event_json) {
        ...
        try {
            const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(wrapper_event_id_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(welcome_event_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len2 = WASM_VECTOR_LEN;
            const ret = wasm.wasmruntime_process_welcome_event_json(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var ptr4 = ret[0];
            var len4 = ret[1];
            if (ret[3]) {
                ptr4 = 0; len4 = 0;
     ...
     * @returns {string}
     */
    process_welcome_json(group_id) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(group_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmruntime_process_welcome_json(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {string}
     */
    publish_keypackage_payload_json() {
        let deferred2_0;
        let deferred2_1;
        try {
            const ret = wasm.wasmruntime_publish_keypackage_payload_json(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    snapshot_json() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmruntime_snapshot_json(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('pikachat_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
